        ...
        <div className="terminal">
            <div className="top-menu-row">
                ...
                <div className="middle-settings-options">
                    {visibility.filings && <button onClick={openFiling}>
                        <div className="pin-commands">
                            <span>CF</span>
                        </div>
                    </button>}

                    {visibility.holders && <button onClick={openSettings}>
                    <div className="pin-commands">
                            <span>HDS</span>
                        </div>
                    </button>}

                    {visibility.news && <button onClick={openSettings}>
                        <div className="pin-commands">
                            <span>N</span>
                        </div>
                    </button>}

                    {visibility.focus && <button onClick={openSettings}>
                        <div className="pin-commands">
                            <span>FOCUS</span>
                        </div>
                    </button>}
                     
                    {visibility.chart && <button onClick={openSettings}>
                        <div className="pin-commands">
                            <span>C</span>
                        </div>
                    </button>}

                    {visibility.help && <button onClick={openSettings}>
                        <div className="pin-commands">
                            <span>HELP</span>
                        </div>
                    </button>}

                    {visibility.chat && <button onClick={openSettings}>
                        <div className="pin-commands">
                            <span>CHAT</span>
                        </div>
                    </button>}
                    
                    {visibility.quoteMonitor && <button onClick={openSettings}>
                        <div className="pin-commands">
                            <span>QM</span>
                        </div>
                    </button>}

                    {visibility.accountManagement && <button onClick={openSettings}>
                        <div className="pin-commands">
                            <span>ACM</span>
                        </div>
                    </button>}

                    {visibility.userBiography && <button onClick={openSettings}>
                        <div className="pin-commands">
                            <span>BIO</span>
                        </div>
                    </button>}

                    {visibility.description && <button onClick={openSettings}>
                        <div className="pin-commands">
                            <span>DES</span>
                        </div>
                    </button>}

                    {visibility.financials && <button onClick={openSettings}>
                        <div className="pin-commands">
                            <span>FA</span>
                        </div>
                    </button>}

                    {visibility.settings && <button onClick={openSettings}>
                        <div className="pin-commands">
                            <span>PDF</span>
                        </div>
                    </button>}

                    {visibility.timeAndSales && <button onClick={openSettings}>
                        <div className="pin-commands">
                            <span>TAS</span>
                        </div>
                    </button>}

                    {visibility.companyEvents && <button onClick={openSettings}>
                        <div className="pin-commands">
                            <span>EVT</span>
                        </div>
                    </button>}

                    {visibility.optionChain && <button onClick={openSettings}>
                        <div className="pin-commands">
                            <span>OPT</span>
                        </div>
                    </button>}

                    {visibility.equityScreener && <button onClick={openSettings}>
                        <div className="pin-commands">
                            <span>EQS</span>
                        </div>
                    </button>}

                    {visibility.initialPublicOfferings && <button onClick={openSettings}>
                        <div className="pin-commands">
                            <span>IPO</span>
                        </div>
                    </button>}
                    
                    {visibility.wordIndices && <button onClick={openSettings}>
                        <div className="pin-commands">
                            <span>WI</span>
                        </div>
                    </button>}
            ...
            { openSetting &&
                <Settings 
                    closeSettings={closeOpenSettings}  
            ...
            {openFilings && 
                <Filings 
                    closeOpenFilings={closeOpenFilings}
            />}
